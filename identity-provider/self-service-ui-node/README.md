...
port. Cookies set for `0.0.0.0:4433` will thus also be sent when requesting
`0.0.0.0:4455`. For environments where applications run on separate
...
export KRATOS_PUBLIC_URL=http://0.0.0.0:4433/
export PORT=4455
