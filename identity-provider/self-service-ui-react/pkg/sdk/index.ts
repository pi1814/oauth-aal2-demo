...
const apiBaseFrontendUrlInternal =
  process.env.NEXT_PUBLIC_KRATOS_PUBLIC_URL || baseUrlInternal

const apiBaseOauth2UrlInternal = process.env.NEXT_PUBLIC_HYDRA_ADMIN_URL || baseUrlInternal

const apiBaseIdentityUrl = process.env.NEXT_PUBLIC_KRATOS_ADMIN_URL || baseUrlInternal
